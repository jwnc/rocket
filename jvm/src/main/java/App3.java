 ...
 */
public class App3 {
    static String filePath = "C:\\projects\\ucar\\rocket\\jvm\\src\\test\\java";
    static String sourceDir = "C:\\projects\\ucar\\rocket\\jvm\\src\\test\\java";
    ...
    private static void invoke(String classPath) throws Exception {
        ...
        try {
            method.invoke(clazz.newInstance(), new File("D:\\downloads\\02-02 常见的中间件服务.wmv"));
