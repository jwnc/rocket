...
public class AlgoVisualizer {
    ...
    public static final int BLOCK_FIXED = 500; // 除以行数得到blockSide
    ...
    public AlgoVisualizer(int N, int M) {
        ...
        int sceneWidth = data.M() / 2 * blockSide + (data.N() - data.N() / 2) * lineHeight + AlgoFrame.fixedOffset;
    ...
    private void run() {
        ...
        Position first = new Position(data.getEntranceX(), data.getEntranceY());
        queue.add(first);
