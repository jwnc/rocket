package box.autoresolve.qihe.logic.GUI;
                    ...
                    case '.':
                        ...
                        if (map[box.y][box.x] == '-') {
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                @Override
                                public void run() {
                                    boxLabel.setIcon(new ImageIcon("algorithm/src/main/resources/qihe/box.png"));
                                }
                            });
                        } else {
                            map[box.y][box.x] = '*';
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                @Override
                                public void run() {
                                    boxLabel.setIcon(new ImageIcon("algorithm/src/main/resources/qihe/boxarrive.png"));
                                }
                            });
                        }
